...
```{r, fig.cap = "Proportion of Delayed Flights by Year (2022 vs 2023)"}
fl <- fl %>%
...
```{r delay_rate_weekday, fig.cap="Delay Rate by Day of Week"}
...
```{r delay_rate_dep_time, fig.cap="Delay Rate by Scheduled Departure Time Block"}
...
```{r, fig.cap = "Delay Rate by Carrier"}
...
```{r, fig.cap = "Departure Delay Distribution by Distance Group"}
fl %>%
...
```{r, fig.cap = "Top Features from Logistic Regression Model"}
...
```{r, fig.cap = "XGBoost Training and Validation AUC Over Boosting Rounds"}
...
```{r, fig.cap = "Top Features from XGBoost Model"}
